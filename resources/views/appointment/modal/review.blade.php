            ...
            <input type="hidden" id="proof_of_payment_01">
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <input class="form-control form-control" type="text" value="{{ $firstName }}" aria-label="default input example" disabled>
                    </div>    
                    <div class="col-md-3">
                        <label for="">Last Name</label>
                        <input class="form-control form-control" type="text" value="{{ $lastName }}" aria-label="default input example" disabled>
                    </div>  
                    <div class="col-md-3">
                        <label for="">Middle Name</label>
                        <input class="form-control form-control" type="text" value="{{ $middleName }}" aria-label="default input example" disabled>
                    </div>  
                    <div class="col-md-3">
                        <label for="">Suffix</label>
                        <input class="form-control form-control" type="text" value="{{ $suffix }}" aria-label="default input example" disabled>
                    </div>  
                </div>
                <div class="form-group row">
                    <div class="col-md-3">
                        <label for="">Student ID</label>
                        <input class="form-control form-control" type="text" value="{{ $school_id }}" aria-label="default input example" disabled>
                    </div> 
                    <div class="col-md-3">
                        <label for="">Cellphone No.</label>
                        <input class="form-control form-control" type="text" value="{{ $cell_no }}" aria-label="default input example" disabled>
                    </div>    
                    <div class="col-md-3">
                        <label for="">Email</label>
                        <input class="form-control form-control" type="email" value="{{ $email }}" aria-label="default input example" disabled>
                    </div>  
                    <div class="col-md-3">
                        <label for="">Address</label>
                        <input class="form-control form-control" type="text" value="{{ $address }}" aria-label="default input example" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-4">
                        <label for="">Civil Status</label>
                        <input class="form-control form-control" type="text" value="{{ $civil_status }}" aria-label="default input example" disabled>
                    </div>    
                    <div class="col-md-4">
                        <label for="">Birthdate</label>
                        <input class="form-control form-control" type="text" value="{{ $birthdate }}" aria-label="default input example" disabled>
                    </div>    
                    <div class="col-md-4">
                        <label for="">Gender</label>
                        <input class="form-control form-control" type="text" value="{{ $gender }}" aria-label="default input example" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input class="form-control form-control" type="text" value="{{ $course }}" aria-label="default input example" disabled>
                    </div>
