    ...
    <div class="container my-5">
        <div id="settings_acc-set" class="font-nun">
            ...
            <div class="d-flex flex-column" style="padding: 0 10%;">
                ...
                <div class="d-flex flex-column px-5 py-4">
                    ...
                    <div class="mb-2 d-flex flex-row row align-items-center">
                        <div class="col-md-4">
                            <label for="update_retype_admin_email">Email</label>
                        </div>
                        <div class="col-md-5">
                            <input type="email" class="form-control settings-input" id="update_retype_admin_email" name="update_retype_admin_email" required>
                        </div>
                    </div>
                    <div class="mb-2 d-flex flex-row row align-items-center">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control settings-input" id="update_admin_cp_no" name="update_admin_cp_no" required>
                        </div>
                    </div>
                    <div class="mt-2 d-flex flex-row justify-content-end">
        ...
        <div id="settings_registrar-staff" class="font-nun">
            <div class="d-flex flex-column" style="padding: 0 10%;">
                    ...
                    <div class="d-flex flex-column row px-5 py-4">
                        <form action="">
                            <div class="mb-2 d-flex flex-row row align-items-center">
                                ...
                                <div class="col-md-5">
                                    <input class="form-control" id="upload_staff_img" type="file" required>
                                </div>
                            </div>
                            <div class="mb-2 d-flex flex-row row align-items-center">
                                <div class="col-md-4">
                                    <label for="update_admin_name">Full Name</label>
                                </div>
                                <div class="col-md-5">
                                    <input type="text" class="form-control settings-input" id="update_admin_name" name="update_admin_name" required>
                                </div>
                            </div>
                            <div class="mb-2 d-flex flex-row row align-items-center">
                                <div class="col-md-4">
                                    <label for="update_admin_position">Position</label>
                                </div>
                                <div class="col-md-5">
                                    <input type="text" class="form-control settings-input" id="update_admin_position" name="update_admin_position" required>
                                </div>
                            </div>
                            <div class="mt-2 d-flex flex-row justify-content-end">
                ...
                <div class="d-flex flex-row px-5 py-4">
                    <div class="settings-prof-img me-4">
                        <img src="/images/registrar.png" alt="Profile Staff">
                    </div>
                    <div class="d-flex flex-column justify-content-end" style="flex: 1;">
                        <p class="font-bold m-0">Prof. Javer C. Borngo</p>
                        <p class="m-0 mb-2">Registrar Head</p>
                        <div class="d-flex flex-row justify-content-start flex-wrap">
                            <button class="btn settings-btn-white d-flex flex-row align-items-center me-2" data-bs-toggle="collapse" data-bs-target="#edit_staff" type="button">
                                <img src="/images/edit.png" alt="">
                                <small class="m-0 ms-2 p-0 font-nun">Edit</small>
                            </button>
                            <button class="btn settings-btn-white d-flex flex-row align-items-center" data-bs-toggle="collapse" data-bs-target="#delete_staff" type="button">
                ...
                <!-- todo edit staff -->
                <div id="edit_staff" class="collapse">
                    <div class="d-flex flex-column row px-5 py-4">
                        <form action="">
                            <div class="mb-2 d-flex flex-row row align-items-center">
                                <div class="col-md-4">
                ...
                <!-- todo delete staff -->
                <div id="delete_staff" class="collapse">
                    <div class="d-flex flex-column row px-5 py-4">
                        <form action="">
                            <div class="mb-2 d-flex flex-row row justify-content-center">
                                Are you sure to delete this staff information?
                            </div>
                            <div class="mt-2 d-flex flex-row justify-content-end">
